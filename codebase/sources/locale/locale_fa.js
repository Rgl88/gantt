...
gantt.locale = {
  date: {
    ...
    month_short: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"],
  ...
  labels: {
    ...
    icon_edit: "ویرایش",
    icon_delete: "حذف",
    confirm_closing: "",//تغییرات شما از بین خواهد رفت، آیا مطمئن هستید؟
    confirm_deleting: "فعالیت مورد نظر به طور دائمی حذف خواهد شد، آیا مطمئن هستید؟",
